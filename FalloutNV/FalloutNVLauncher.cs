...
namespace Nexus.Client.Games.FalloutNV
{
	...
	public class FalloutNVLauncher : GameLauncherBase
	{
		...
		/// </summary>
		private void LaunchFalloutNV4GB()
		{
			Trace.TraceInformation("Launching Fallout: New Vegas (4Gb)...");
			Trace.Indent();

			string strCommand = Get4GbLaunchCommand();
			Trace.TraceInformation("Command: " + strCommand);
		...
		private string Get4GbLaunchCommand()
		{
